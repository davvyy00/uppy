...
module.exports = function (_Component) {
  ...
  FileCard.prototype.renderMetaFields = function renderMetaFields(file) {
    ...
    metaFields.forEach(function (field) {
      var selected = file.meta[field.id];
      if (field.type === 'toggle') {
        meta.push(h(
          'div',
          { 'class': 'uppy-DashboardFileCard-fieldset uppy-toggle-field' },
          h(
            'div',
            { className: 'uppy-toggle-label' },
            h(
              'label',
          ...
          h(
            'div',
            { className: 'uppy-toggle' },
            selected ? h('input', { type: 'checkbox', id: field.id,
              onClick: function onClick(e) {
                me.meta[field.id] = e.target.checked;
              },
              checked: true }) : h('input', { type: 'checkbox', id: field.id,
              onClick: function onClick(e) {
                console.log(file);
                me.meta[field.id] = e.target.checked;
              }
