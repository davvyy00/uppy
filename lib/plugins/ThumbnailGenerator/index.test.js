...
describe('uploader/ThumbnailGeneratorPlugin', function () {
  ...
  describe('onRestored', function () {
    it('should enqueue restored files', function () {
      var files = {
        a: { preview: 'blob:abc', isRestored: true },
        b: { preview: 'blob:def' },
        c: { preview: 'blob:xyz', isRestored: true }
      };
      var core = _extends(emitter(), {
    ...
    it('should not regenerate thumbnail for remote files', function () {
      var files = {
