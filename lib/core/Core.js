...
var getFileNameAndExtension = require('../utils/getFileNameAndExtension');
var generateFileID = require('../utils/generateFileID');
var isObjectURL = require('../utils/isObjectURL');
var getTimeStamp = require('../utils/getTimeStamp');
...
var Uppy = function () {
  ...
  */
  ...
  Uppy.prototype.emitDeleteFileEvent = function emitDeleteFileEvent(file) {
    var _this3 = this;

    return function () {
      _this3.emit('file-deleted', file.id);
      _this3.log('File deleted: ' + file.id);
    };
  };
  ...
  Uppy.prototype._addListeners = function _addListeners() {
    ...
    this.on('upload-error', function (file, error) {
      _this6.setFileState(file.id, { error: error.message });
      _this6.setState({ error: error.message });

      var message = _this6.i18n('failedToUpload', { file: file.name });
  ...
  */
  ...
  Uppy.prototype._runUpload = function _runUpload(uploadID) {
    ...
    steps.forEach(function (fn, step) {
      ...
      lastStep = lastStep.then(function () {
        ...
        var _getState5 = _this9.getState(),
    ...
    return lastStep.then(function () {
      ...
      _this9.addResultData(uploadID, { successful: successful, failed: failed, uploadID: uploadID });
  ...
  Uppy.prototype.upload = function upload() {
    ...
    return _Promise.resolve().then(function () {
      ...
      var _getState7 = _this10.getState(),
      ...
      _this10.info({ message: message, details: details }, 'error', 4000);
