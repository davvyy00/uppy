...
jest.mock('../utils/findDOMElement', function () {
  return function () {
    return null;
  };
});
...
describe('src/Core', function () {
  ...
  it('should close, reset and uninstall when the close method is called', function () {
    ...
    var coreCancelEventMock = jest.fn();
    var coreStateUpdateEventMock = jest.fn();
    var plugin = core.plugins.acquirer[0];
  ...
  describe('preprocessors', function () {
    ...
    it('should execute all the preprocessors when uploading a file', function () {
      ...
      return core.upload().then(function () {
        var fileId = Object.keys(core.getState().files)[0];
  ...
  describe('progress', function () {
    ...
    it('should calculate the total progress of all file uploads', function () {
      ...
      var _core$getFiles = core.getFiles(),
          file1 = _core$getFiles[0],
          file2 = _core$getFiles[1];

      core.setFileState(file1.id, { progress: _extends({}, file1.progress, { uploadStarted: new Date() }) });
      core.setFileState(file2.id, { progress: _extends({}, file2.progress, { uploadStarted: new Date() }) });
    ...
    it('should reset the progress', function () {
      ...
      var _core$getFiles2 = core.getFiles(),
          file1 = _core$getFiles2[0],
          file2 = _core$getFiles2[1];
  ...
  describe('createUpload', function () {
    it('should assign the specified files to a new upload', function () {
      ...
      var uploadId = Object.keys(core.getState().currentUploads)[0];
